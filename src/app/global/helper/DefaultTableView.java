...
public class DefaultTableView {
    ...
    public void InitializeTablePatient() {
        TableModel = (DefaultTableModel) TableObject.getModel();

        CellAlignCenter.setHorizontalAlignment(0);
        CellAlignRight.setHorizontalAlignment(SwingConstants.RIGHT);

        TableObject.setRowHeight(30);
        TableObject.setColumnSelectionAllowed(false);
        TableModel.setNumRows(0);
    }
    
        public void InitializeTableLarge() {
        TableModel = (DefaultTableModel) TableObject.getModel();

        CellAlignCenter.setHorizontalAlignment(0);
        CellAlignRight.setHorizontalAlignment(SwingConstants.RIGHT);

        TableObject.setRowHeight(43);
        TableObject.setColumnSelectionAllowed(false);
        TableModel.setNumRows(0);
    }

    public void InitializeTableMDH() {
        TableModel = (DefaultTableModel) TableObject.getModel();

        CellAlignCenter.setHorizontalAlignment(0);
        CellAlignRight.setHorizontalAlignment(SwingConstants.RIGHT);

        TableObject.setRowHeight(24);
        TableObject.setColumnSelectionAllowed(false);
        TableModel.setNumRows(0);
    }
    
    public void InitializeTableMDHChild() {
        TableModel = (DefaultTableModel) TableObject.getModel();
    ...
    public void RenderTable() {
        ...
        TableObject.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        TableObject.setSelectionBackground(new Color(153, 204, 255));
        TableObject.setSelectionForeground(Color.BLACK);
    }

    public void RenderTableNoID() {
        TableObject.setCellSelectionEnabled(false);
        TableObject.setRowSelectionAllowed(true);
        TableObject.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        TableObject.setSelectionBackground(new Color(153, 204, 255));
