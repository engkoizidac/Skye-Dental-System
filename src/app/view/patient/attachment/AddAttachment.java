 ...
 */
public class AddAttachment extends javax.swing.JDialog {
    ...
    public AddAttachment(Attachment parent, boolean modal) {
...
//        fileChooser.addChoosableFileFilter(new FileNameExtensionFilter("Images", "jpg", "png", "gif", "bmp"));
    ...
    private void cmdaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdaddActionPerformed
        if (txtdesc.getText().isEmpty() == true || txtpath.getText().isEmpty() == true) {
            ...
            int MaxId= Controller.Add(DateFormatted);
            FTPFactory ftp = new FTPFactory();
            ftp.FTPSaveFile(txtpath.getText(), "/img/" +MaxId + ".jpg");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddAttachment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddAttachment dialog = new AddAttachment(frmParent, true);
