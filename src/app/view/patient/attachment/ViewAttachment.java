 ...
 */
public class ViewAttachment extends javax.swing.JDialog {
    ...
    public ViewAttachment(Attachment parent, boolean modal) {
...
void OpenImage(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAttachment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewAttachment dialog = new ViewAttachment(frmParent, true);
