...
public class PatientSignInformedConsent extends javax.swing.JDialog {
    ...
    public PatientSignInformedConsent(InformedConcentManage parent, boolean modal) {
...
//        cg.setComposite(AlphaComposite.Src);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        SigFile.setFileName(Id + ".png");
        SigFile.SaveSignatureInformedConsent();

        Controller.setISId(Id);
        Controller.UpdateToSigned();
